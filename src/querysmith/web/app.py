...
def create_app() -> FastAPI:
    ...
    def delete_connection(store: SessionStore = Depends(get_session_store)) -> None:
        store.clear()
    ...
    def get_views(
        ...
        return ViewsResponse(
            views=[
                ViewItem(schema_name=v.schema_name, view_name=v.view_name, qualified_name=v.qualified_name)
                for v in views
            ]
        )
